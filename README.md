...
Prerequisite for running the tests: you need to have a local postgres instance up and running, and for which you have access to drop/create databases. See `spec/spec_helper.rb`
